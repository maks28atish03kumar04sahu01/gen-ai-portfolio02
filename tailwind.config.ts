  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-up": "fade-up 0.6s cubic-bezier(0.2, 0.9, 0.3, 1) forwards",
        "fade-in": "fade-in 0.5s cubic-bezier(0.2, 0.9, 0.3, 1) forwards",
        "scale-in": "scale-in 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
        "slide-right": "slide-right 0.5s cubic-bezier(0.2, 0.9, 0.3, 1) forwards",
